...
Justificación: he querido hacer esta aplicación relacionada con el fútbol debido a que a mi siempre me ha apasionado el fútbol desde chico sobre todo por mi equipo que es el Sevilla y pues a la hora de hacer el proyecto tenía claro que iba a tener relación con este nicho.

Objetivos: mi objetivo es hacer una aplicación funcional la cuál mis amigos a la hora de verla les entre curiosidad por saber más de ella y sobre todo por descargarla y probarla en sus dispositivos para posteriormente darme el visto bueno.
...
Tecnologías utilizadas: Android Studio para el frontend sabiendo que lo mío va a ser una aplicación móvil. Como lenguaje de programación principal utilizaré java que me ayudará a hacer el backend de la misma aplicación en IntelliJ con Spring Boot de microservicio para realizar el respectivo CRUD principal de la aplicación. Como base de datos utilizaré la MySQL de Workbench. Para testear los endpoints GET,POST,PUT y DELETE que se encuentran en el Controller de mi api utilizaré Postman. Y por último, GitHub me servirá para subir mi proyecto en la nube y una vez subido ir actualizando el proyecto con los respectivos cambios.
